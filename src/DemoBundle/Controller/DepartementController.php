...
use DemoBundle\Entity\Departement;
...
class DepartementController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $departements = $em->getRepository('DemoBundle:Departement')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('DemoBundle\Form\DepartementType', $departement);
    ...
    {
        $deleteForm = $this->createDeleteForm($departement);
        $editForm = $this->createForm('DemoBundle\Form\DepartementType', $departement);
